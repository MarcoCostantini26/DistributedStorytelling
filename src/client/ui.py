...
class StoryClientGUI:
    def __init__(self, master):
        ...
        # UI LAYOUT
        self.header_lbl = tk.Label(master, text="DISTRIBUTED STORYTELLING", bg=BG_COLOR, fg=SERVER_COLOR, font=("Segoe UI", 14, "bold"))
        ...
        self.timer_lbl = tk.Label(master, text="", bg=BG_COLOR, fg=TIMER_COLOR, font=FONT_TIMER)
    ...
    def send_message(self, event):
        ...
        if self.phase == STATE_EDITING:
            ...
            t = text.upper()
            if t == "S": send_json(self.sock, {"type": CMD_VOTE_RESTART}); self.log("Voto SÌ.", "info"); self.stop_timer()
