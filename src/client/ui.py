...
class StoryClientGUI:
    ...
    def process_incoming_message(self, msg):
        ...
        if msg_type == EVT_WELCOME:
            ...
            self.log(f"[SISTEMA] Voti: {msg.get('count')} / {msg.get('needed')}", "info")
            ...
            if msg.get('msg'):
                self.log(f"MOTIVO: {msg.get('msg')}", "error")
            # --------------------------------------------
    ...
    def send_message(self, event):
        ...
        if self.phase == STATE_EDITING:
            ...
            if t == "S":
                ...
                self.log("Voto SÌ.", "info")
            elif t == "N":
                send_json(self.sock, {"type": CMD_VOTE_NO})
                self.log("Voto NO.", "info")
