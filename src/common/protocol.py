...
CMD_DECIDE_CONTINUE = "DECIDE_CONTINUE" # Narratore -> Server: "CONTINUE" o "STOP"
...
EVT_ASK_CONTINUE = "ASK_CONTINUE"      # Server -> Narratore: "Vuoi continuare?"
EVT_GAME_ENDED = "GAME_ENDED"           # Server -> Tutti: "Partita finita"
